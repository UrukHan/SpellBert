...
from subwordbert import load_model, load_pretrained, model_predictions, model_inference
...
class BertChecker(Corrector):
    ...
    def __init__(self, **kwargs):
        ...
        self.bert_pretrained_name_or_path = 'DeepPavlov/rubert-base-cased-conversational'
